...
<title><?= t('help.title', 'Pusat Bantuan') ?></title>
...
<header class="bg-white sticky top-0 z-40 px-5 py-4 border-b border-stone-100">
    <div class="max-w-3xl mx-auto flex items-center gap-3">
        ...
        <h1 class="headline font-black text-lg text-[#b22204]"><?= t('help.heading', 'Pusat Bantuan') ?></h1>
    </div>
</header>
<main class="max-w-3xl mx-auto px-5 py-6 space-y-4">
    <section class="rounded-[2rem] bg-gradient-to-r from-[#b22204] to-[#ff6b35] text-white p-6">
        <p class="text-xs font-bold uppercase tracking-widest text-white/70"><?= t('help.help_center', 'Help Center') ?></p>
        <h2 class="headline text-2xl font-black mt-2"><?= t('help.help_desc', 'Ada kendala pesanan?') ?></h2>
        <p class="text-sm text-white/80 mt-2"><?= t('help.help_detail', 'Cek panduan cepat di bawah atau hubungi admin kantin/sekolah.') ?></p>
    </section>
    <?php
    $faqs = [
