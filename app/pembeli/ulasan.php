...
$query = mysqli_query($koneksi, "SELECT detail_pesanan.*, menu.nama_menu, menu.foto_menu, kantin.nama_kantin 
    FROM detail_pesanan 
    ...
    <main class="pt-24 pb-32 px-6 max-w-2xl mx-auto">
        <section class="mb-12 flex items-start gap-6">
            <div class="w-32 h-32 rounded-xl overflow-hidden shadow-lg">
                <img class="w-full h-full object-cover" src="../../uploads/<?= $d['foto_menu'] ?>">
            </div>
