        ...
        <div class="lg:col-span-2 bg-white rounded-3xl p-4 md:p-6 shadow-lg border border-gray-100">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-4">
                ...
                <div class="bg-gradient-to-br from-orange-50 to-white rounded-2xl p-4 border border-orange-100 relative hover:shadow-lg transition-all">
                    <?php if ($rank <= 3): ?>
                    <div class="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-gradient-to-br <?= $rank == 1 ? 'from-yellow-400 to-orange-500' : ($rank == 2 ? 'from-slate-300 to-slate-400' : 'from-amber-600 to-amber-700') ?> flex items-center justify-center text-white font-black text-xs shadow-lg z-20">
                        <?= $rank ?>
                    </div>
                    <?php endif; ?>
