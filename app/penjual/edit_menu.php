...
if (isset($_POST['update'])) {
    ...
    if ($_FILES['foto']['name'] != "") {
        ...
        move_uploaded_file($tmp_name, "../../uploads/" . $foto_name);
            ...
            <div>
                ...
                <div class="flex items-center gap-4">
                    <?php if (!empty($data['foto'])): ?>
                        <img src="../../uploads/<?= htmlspecialchars($data['foto']) ?>" class="w-20 h-20 rounded-2xl object-cover border">
                    <?php endif; ?>
